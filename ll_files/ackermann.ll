; ModuleID = './Shootout/ackermann/ackermann.c'
source_filename = "./Shootout/ackermann/ackermann.c"
...
define dso_local i32 @Ack(i32, i32) #0 {
...
; <label>:15:                                     ; preds = %14, %9
  ...
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i32 %17, i32 %19)
  ret i32 0
}
